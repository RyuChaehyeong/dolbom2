...
@Log4j
public class DlbmControllerTests {
    ...
    public void testRegister() throws Exception {
        ...
        String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/dlbm/register")
                .param("srvcNm", "돌봄서비스 등록 테스트")
                .param("animalCtgrCd", "10")
                .param("breedCtgrCd", "10")
                .param("srvcDtl", "testtesttesttest")
                .param("dlbmLoc", "DlbmLoctest")
                .param("dlbmId", "dlbm20")
                .param("createdBy", "dlbm20")
